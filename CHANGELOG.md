...
* **i18n:** adopt i18next-cli as read-only dev assistant (plan 1) ([6f12879](https://github.com/zlh12331/superagent/commit/6f12879ecf8b8d68b0c0f5b62438ed5e0a6d53d6))
...
* **perf:** add three-tier performance benchmark suite ([8208419](https://github.com/zlh12331/superagent/commit/8208419107c2b31f00b63a1bbc85e8faa03d1719))
...
* **scripts:** add check-comments stale annotation audit ([2af83dc](https://github.com/zlh12331/superagent/commit/2af83dc6f0518f0e331df30cfc17530db861deb5))
* **scripts:** add check-file-size gate and strengthen gates ([75a030a](https://github.com/zlh12331/superagent/commit/75a030a091ed18391ee52bad4b68b2b47c343d97))
* **scripts:** align file/function limits with industry practice ([d7ab022](https://github.com/zlh12331/superagent/commit/d7ab0220285db66881753463818de8dacd3f08b4))
...
* **scripts:** wire docs/functions/depcruise into gates ([34940ae](https://github.com/zlh12331/superagent/commit/34940ae87f30dcf6317bb45f21e70f6ce574a9e3))
...
* **security:** add secrets gate and security/data/ipc specs ([aa19252](https://github.com/zlh12331/superagent/commit/aa1925290e895a6f57ca5320a68729247181e835))
* **security:** adopt gitleaks as industry-standard secrets gate ([4b01bd9](https://github.com/zlh12331/superagent/commit/4b01bd96bc4f2c9ee46e5bf62505909810c2ff5d))
...
* **telemetry:** memory leak deep-dive toolchain (snapshot + monitor + inspect) ([cace85e](https://github.com/zlh12331/superagent/commit/cace85e737775b4b03aff1556c17aea017ec431e))
* **test:** 测试边界程序化门禁 ([b28d9c0](https://github.com/zlh12331/superagent/commit/b28d9c00963f45410cffba74f48c3a5673075f4e))
* **tokens:** adopt Style Dictionary as token single source ([a47e199](https://github.com/zlh12331/superagent/commit/a47e199bddb1a7bda38b53f3922382755da26147))
...
* hash routing for production file:// and E2E debug port ([bcfeb38](https://github.com/zlh12331/superagent/commit/bcfeb38cf373fb8319524117318a13c937040c37))
...
* **perf:** heap snapshot dump had 3 unreachable/wrong-layer bugs ([a29ce93](https://github.com/zlh12331/superagent/commit/a29ce933ba98fe3580745ca418c470d657bc1240))
...
* **test:** exclude perf benchmarks from regular test:main ([9293ab1](https://github.com/zlh12331/superagent/commit/9293ab11e91c5b573107d799afd691a1035572fa))
