...
| `web-tree-sitter`                   | `^0.27.0`            | tree-sitter 解析                                                                                  |
| `@cursorless/tree-sitter-wasms`     | `^0.10.0`            | tree-sitter WASM 语法包（2026-09-04：原 tree-sitter-wasms 0.1.13 停更且旧 dylink ABI 与 0.25+ 运行时不兼容，整体升级） |
